...
def get_chunk_by_id(chunks: List[Dict[str, Any]], chunk_id: str) -> Optional[Dict[str, Any]]:
    """
...
def get_chunk_children(chunks: List[Dict[str, Any]], chunk_id: str) -> List[Dict[str, Any]]:
    """
...
def get_chunk_tree(chunks: List[Dict[str, Any]], chunk_id: Optional[str] = None) -> Dict[str, Any]:
    """
