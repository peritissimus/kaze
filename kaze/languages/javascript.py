"""
JavaScript language parser for Tree-sitter.
Implements JavaScript-specific parsing rules for extracting code chunks.
"""
...
class JavaScriptParser(BaseLanguageParser):
    ...
    GRAMMAR_REPO = "https://github.com/tree-sitter/tree-sitter-javascript"

    def _get_language(self):
        """Get the Tree-sitter Language object for JavaScript."""
    ...
    def extract_chunks(self, source_code: str, file_path: str) -> List[Dict[str, Any]]:
        """Extract code chunks from JavaScript source code."""
        chunks = []
    ...
    def _process_node(
        ...
        # Check if the node is a class, function, method, or arrow function
        if (
            ...
            if node_name == "unnamed" and (
                node.type == "arrow_function" or node.type == "function"
            ):
    ...
    def get_node_type(self, node: Node) -> str:
        """Get the type of a Tree-sitter node for JavaScript."""
    ...
    def get_node_name(self, node: Node, source_code: str) -> str:
        """Get the name of a Tree-sitter node for JavaScript."""
        if node.type == "class_declaration" or node.type == "function_declaration":
            ...
            # Try to find a parent assignment or property
            # This is more complex and would require context
            return "arrow_function"

        return "unnamed"


# Register the JavaScript parser
register_language(JavaScriptParser.LANGUAGE_ID, JavaScriptParser)
